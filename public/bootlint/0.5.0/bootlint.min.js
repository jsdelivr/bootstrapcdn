...
SemVer.prototype.inc=function(release){switch(release){case"premajor":this.prerelease.length=0;this.patch=0;this.minor=0;this.major++;this.inc("pre");break;case"preminor":this.prerelease.length=0;this.patch=0;this.minor++;this.inc("pre");break;case"prepatch":// If this is already a prerelease, it will bump to the next version
...
theWindow=window}catch(e){}if(theWindow){// check browser global jQuery
var globaljQuery=theWindow.$||theWindow.jQuery;if(globaljQuery){var globalVersion=null;try{globalVersion=globaljQuery.fn.jquery}catch(e){}if(globalVersion){// pad out short version numbers (e.g. '1.7')
