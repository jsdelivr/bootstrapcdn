 ...
 */
/*eslint-env node */
var cheerio=require("cheerio");(function(exports){"use strict";var COL_CLASSES=[];var SCREENS=["xs","sm","md","lg"];SCREENS.forEach(function(screen){for(var n=1;n<=12;n++){COL_CLASSES.push(".col-"+screen+"-"+n)}});var IN_NODE_JS=!!cheerio.load;function isDoctype(node){return node.type==="directive"&&node.name==="!doctype"}function filenameFromUrl(url){var filename=url.replace(/[#?].*$/,"");// strip querystring & fragment ID
